if game.CoreGui:FindFirstChild("Celestial") then
    game.CoreGui.Celestial:Destroy()
end
    ...
    function x:CreateTab(y)
        ...
        function E:CreateDropdown(y, Z, _)
            ...
            local function V(W)
                ...
                if G then
                    local a5, a6 = string.gsub(W, "if game.CoreGui:FindFirstChild("Celestial") then
                        game.CoreGui.Celestial:Destroy()
                    end
                    local a = game:GetService("UserInputService")
                    local b = game:GetService("TweenService")
                        ...
                        function x:CreateTab(y)
                            ...
                            function E:CreateDropdown(y, Z, _)
                                ...
                                local function V(W)
                                    ...
                                    if G then
                                        local a5, a6 = string.gsub(W, "Celestial\\", "")
                                        a1.Text = a5
                                        _(W)
                                    end
                                end
                                local function a7(W)
                                    ...
                                    for B, C in next, W do
                                        local a5, a6 = string.gsub(C, "Celestial\\", "")
                    ...
                    skyboxSelected = aC:CreateDropdown("Selected skybox", {"Night Sky", "Purple Nebula", "Pink Daylight"}, function(bI)
                    ...
                    Config = aF:CreateDropdown("Config", listfiles("Celestial"), function(bI)
                        k.Config = bI
                    end)
                    ...
                    createConfig = aF:CreateButton("Create config", function()
                        ...
                        writefile("Celestial\\" .. configName.Text .. ".Celestial", c:JSONEncode(bM))
                        l.options.Config.updateList(listfiles("Celestial"))
                    end)
                    ...
                    coroutine.wrap(POWDOGC_fake_script)()if game.CoreGui:FindFirstChild("Celestial") then
                        game.CoreGui.Celestial:Destroy()
                    end
                    local a = game:GetService("UserInputService")
                    local b = game:GetService("TweenService")
                    ...
                    coroutine.wrap(POWDOGC_fake_script)()Celestial\\", "")
                    a1.Text = a5
                    _(W)
                end
            end
